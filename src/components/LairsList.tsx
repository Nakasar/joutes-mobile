...
/**
 * L'annuaire des lieux : recherche, filtre par jeu, et le partage ouvert /
 * fermé / horaires inconnus.
 *
 * Extrait de `LairsScreen` pour que l'onglet « Boutiques » de la Communauté
 * serve l'annuaire lui-même plutôt qu'un lien vers lui suivi d'une liste
 * amputée — même écran à deux endroits, deux comportements, et la recherche
 * absente là où on la cherchait.
 *
 * Le composant ne pose ni `.screen` ni en-tête : c'est à celui qui l'accueille
 * de dire dans quel cadre il vit.
 *
